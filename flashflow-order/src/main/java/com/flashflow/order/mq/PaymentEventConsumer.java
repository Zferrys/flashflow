...
public class PaymentEventConsumer {
    ...
    @RabbitHandler
    @RabbitListener(queues = "queue.order.paid", ackMode = "MANUAL")
    ...
    @RabbitHandler
    @RabbitListener(queues = "queue.order.refund.success", ackMode = "MANUAL")
    ...
    @RabbitHandler
    @RabbitListener(queues = "queue.order.payment.fail", ackMode = "MANUAL")
