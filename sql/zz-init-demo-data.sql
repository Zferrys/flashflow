...
-- ========================================
-- 3. C 端演示用户 (flashflow_auth)
-- ========================================
USE flashflow_auth;

-- 仅当手机号不存在时插入
INSERT IGNORE INTO user_info (phone, password, nickname, status, create_time) VALUES
('13800138001', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', '秒杀用户01', 1, NOW()),
('13800138002', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', '秒杀用户02', 1, NOW()),
('13800138003', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', '测试用户', 1, NOW());
...
--   方法1: 对每个活动 POST /api/flashflow/promotion/activity/{id}/publish
--   方法2: 前端 → 活动管理 → 点击活动 "发布"
--
-- 演示账号:
--   管理员: 见项目文档
--   C 端:   13800138001 / password
--   C 端:   13800138002 / password
--   C 端:   13800138003 / password
--   (BCrypt 密码工作已在 Auth 模块的 register 接口中自动加密，此处为存量演示数据)
